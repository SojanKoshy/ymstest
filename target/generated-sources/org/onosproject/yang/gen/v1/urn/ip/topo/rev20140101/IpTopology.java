...
/**
 * Abstraction of an entity which represents the functionality of ipTopology.
 */
public interface IpTopology {
     ...
     * @return match result
     */
    IpTopology processSubtreeFiltering(IpTopology ipTopology, boolean isSelectAllSchemaChild);
}
