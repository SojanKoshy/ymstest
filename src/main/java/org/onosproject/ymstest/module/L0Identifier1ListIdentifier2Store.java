...
public class L0Identifier1ListIdentifier2Store implements ListIdentifier2 {
    ...
    public void processEdit(ListIdentifier2 listIdentifier2) {
        ...
        if (containerNode.yangListIdentifier2OpType() == null) {
         ...
         */
        processLeafListIdentifer2Edit(listIdentifier2, containerNode.yangListIdentifier2OpType());

        /*
         * Process the child nodes
         */
        processContainerIdentifier2Edit(listIdentifier2,
                containerNode.yangListIdentifier2OpType());
...
*/
        ...
        switch (containerNode.yangListIdentifier2OpType()) {
            case CREATE: {
    ...
    private void processContainerIdentifier2Edit(
            ListIdentifier2 listIdentifier2, ModuleIdentifier0.OnosYangOpType
        ...
        switch (listIdentifier2.containerIdentifier3().yangContainerIdentifier3OpType()) {
            case CREATE: {
